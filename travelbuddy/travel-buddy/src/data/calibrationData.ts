...
export const VIBE_DUELS: DuelConfig[] = [
  {
    id: 'vibe-duel-1',
    leftLabel: 'Nightlife & Clubs',
    leftImage: '/goa/fire-dancing.jpg',
    leftTags: ['Nightlife', 'Party', 'Music', 'Night', 'Social', 'Fun'],
    rightLabel: 'Peaceful & Relaxing',
    rightImage: '/goa/sunset-purple.jpg',
    rightTags: ['Peaceful', 'Quiet', 'Calm', 'Relax', 'Solitude', 'Wellness'],
  },
  {
    id: 'vibe-duel-2',
    leftLabel: 'Beach & Chill',
    leftImage: '/goa/shack-curlies.jpg',
    leftTags: ['Beach', 'Chill', 'Relax', 'Sea', 'Coastal', 'Social'],
    rightLabel: 'Nature & Adventure',
    rightImage: '/goa/dudhsagar.jpg',
    rightTags: ['Nature', 'Adventure', 'Outdoors', 'Scenic', 'Forest', 'Hiking'],
  },
  {
    id: 'vibe-duel-3',
    leftLabel: 'Party & Social',
    leftImage: '/goa/arambol-party.jpg',
    leftTags: ['Social', 'Party', 'Music', 'Fun', 'Festive', 'Beach'],
    rightLabel: 'Family Friendly',
    rightImage: '/goa/palolem-south.jpg',
    rightTags: ['Family', 'Kids', 'Safe', 'Calm', 'Beach', 'Relax'],
  },
];
...
export const ACTIVITY_DUELS: DuelConfig[] = [
  {
    id: 'activity-duel-1',
    leftLabel: 'Water Sports',
    leftImage: '/goa/jetski-beach.jpg',
    leftTags: ['Water', 'Adrenaline', 'Sport', 'Thrill', 'Beach', 'Active'],
    rightLabel: 'Cycling & Exploring',
    rightImage: '/goa/fontainhas-street.jpg',
    rightTags: ['Active', 'Culture', 'Heritage', 'Local', 'Photography', 'Freedom'],
  },
  {
    id: 'activity-duel-2',
    leftLabel: 'Casino & Entertainment',
    leftImage: '/goa/deltin-casino.jpg',
    leftTags: ['Nightlife', 'Luxury', 'Fun', 'Social', 'Night', 'Premium'],
    rightLabel: 'Nature & Adventure',
    rightImage: '/goa/dudhsagar-2.jpg',
    rightTags: ['Nature', 'Adventure', 'Outdoors', 'Hiking', 'Wildlife', 'Scenic'],
  },
  {
    id: 'activity-duel-3',
    leftLabel: 'Yachts & Sailing',
    leftImage: '/goa/beaches-of-goa.jpg',
    leftTags: ['Sailing', 'Luxury', 'Sea', 'Scenic', 'Premium', 'Romance'],
    rightLabel: 'Boating & Kayaking',
    rightImage: '/goa/mandovi-canoe.jpg',
    rightTags: ['Water', 'Nature', 'Calm', 'Scenic', 'Wildlife', 'Outdoors'],
  },
];
...
export const FOOD_DUELS: DuelConfig[] = [
  {
    id: 'food-duel-1',
    leftLabel: 'Non-Vegetarian',
    leftImage: '/goa/prawn-curry.jpg',
    leftTags: ['Food', 'Local', 'Gastronomy', 'Culture', 'Warm', 'Value'],
    rightLabel: 'Pure Vegetarian',
    rightImage: '/goa/goan-thali.jpg',
    rightTags: ['Food', 'Local', 'Value', 'Budget', 'Culture', 'Gastronomy'],
  },
  {
    id: 'food-duel-2',
    leftLabel: 'Authentic Goan',
    leftImage: '/goa/mackerel-plate.jpg',
    leftTags: ['Food', 'Local', 'Heritage', 'Gastronomy', 'Culture', 'Unique'],
    rightLabel: 'International & Café',
    rightImage: '/goa/juice-siolim.jpg',
    rightTags: ['Café', 'Coffee', 'Food', 'Trendy', 'Chill', 'Design'],
  },
  {
    id: 'food-duel-3',
    leftLabel: 'Seafood',
    leftImage: '/goa/fish-thali.jpg',
    leftTags: ['Food', 'Sea', 'Gastronomy', 'Local', 'Value', 'Beach'],
    rightLabel: 'North Indian',
    rightImage: '/goa/butter-chicken.jpg',
    rightTags: ['Food', 'Gastronomy', 'Warm', 'Value', 'Culture', 'Local'],
  },
];
